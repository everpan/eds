...
${OBJECTDIR}/API/C/edsapi/src/ArchClient.o: API/C/edsapi/src/ArchClient.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/API/C/edsapi/src/ArchClient.o API/C/edsapi/src/ArchClient.cpp

${OBJECTDIR}/API/C/edsapi/src/Backend.o: API/C/edsapi/src/Backend.cpp 
	${MKDIR} -p ${OBJECTDIR}/API/C/edsapi/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/API/C/edsapi/src/Backend.o API/C/edsapi/src/Backend.cpp

${OBJECTDIR}/API/C/edsapi/src/Errors.o: API/C/edsapi/src/Errors.cpp 
	${MKDIR} -p ${OBJECTDIR}/API/C/edsapi/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/API/C/edsapi/src/Errors.o API/C/edsapi/src/Errors.cpp

${OBJECTDIR}/API/C/edsapi/src/LiveClient.o: API/C/edsapi/src/LiveClient.cpp 
	${MKDIR} -p ${OBJECTDIR}/API/C/edsapi/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/API/C/edsapi/src/LiveClient.o API/C/edsapi/src/LiveClient.cpp

${OBJECTDIR}/EdsLiveData.o: EdsLiveData.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/EdsLiveData.o EdsLiveData.cpp

${OBJECTDIR}/EdsPointThread.o: EdsPointThread.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/EdsPointThread.o EdsPointThread.cpp

${OBJECTDIR}/HttpServer.o: HttpServer.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/HttpServer.o HttpServer.cpp

${OBJECTDIR}/KafkaServer.o: KafkaServer.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/KafkaServer.o KafkaServer.cpp

${OBJECTDIR}/PointData.o: PointData.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/PointData.o PointData.cpp

${OBJECTDIR}/TL_Common.o: TL_Common.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/TL_Common.o TL_Common.cpp

${OBJECTDIR}/TL_Datetime.o: TL_Datetime.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/TL_Datetime.o TL_Datetime.cpp

${OBJECTDIR}/TL_Exp.o: TL_Exp.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/TL_Exp.o TL_Exp.cpp

${OBJECTDIR}/TL_IniFile.o: TL_IniFile.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/TL_IniFile.o TL_IniFile.cpp

${OBJECTDIR}/TL_Logger.o: TL_Logger.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/TL_Logger.o TL_Logger.cpp

${OBJECTDIR}/TL_MemString.o: TL_MemString.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/TL_MemString.o TL_MemString.cpp

${OBJECTDIR}/TL_Option.o: TL_Option.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/TL_Option.o TL_Option.cpp

${OBJECTDIR}/TL_Thread.o: TL_Thread.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/TL_Thread.o TL_Thread.cpp

${OBJECTDIR}/TL_ThreadLock.o: TL_ThreadLock.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/TL_ThreadLock.o TL_ThreadLock.cpp
