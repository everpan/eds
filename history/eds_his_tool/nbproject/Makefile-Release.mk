...
${OBJECTDIR}/_ext/29dd86f/BitCompress.o: ../../BitCompress.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/29dd86f/BitCompress.o ../../BitCompress.cpp

${OBJECTDIR}/_ext/29dd86f/TL_Common.o: ../../TL_Common.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/29dd86f
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/29dd86f/TL_Common.o ../../TL_Common.cpp

${OBJECTDIR}/_ext/29dd86f/TL_Datetime.o: ../../TL_Datetime.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/29dd86f
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/29dd86f/TL_Datetime.o ../../TL_Datetime.cpp

${OBJECTDIR}/_ext/29dd86f/TL_Exp.o: ../../TL_Exp.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/29dd86f
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/29dd86f/TL_Exp.o ../../TL_Exp.cpp

${OBJECTDIR}/_ext/29dd86f/TL_Mmap.o: ../../TL_Mmap.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/29dd86f
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/29dd86f/TL_Mmap.o ../../TL_Mmap.cpp

${OBJECTDIR}/_ext/29dd86f/TL_Option.o: ../../TL_Option.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/29dd86f
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/29dd86f/TL_Option.o ../../TL_Option.cpp

${OBJECTDIR}/_ext/29dd86f/sqlite3.o: ../../sqlite3.c
	${MKDIR} -p ${OBJECTDIR}/_ext/29dd86f
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/29dd86f/sqlite3.o ../../sqlite3.c
